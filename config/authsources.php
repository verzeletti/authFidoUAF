...
$config = array(
    ...
    'fidouaf' => array(
		...
		// OpenLDAP
			'ldap_server' => 'ldap://200.135.167.177:389',
		// Tempo para expirar o token (em minutos)
			'token_expire' => '5',
		// Define tamanho do token
			'token_size' => '32',
		// SPs com acesso a todos os atributos.: Separar por OR o endereço dos SPs
...
//    ),
    ...
    */
    ...
    'ldap' => array(
        ...
        'dnpattern' => 'uid=%username%,ou=usuarios,dc=redes,dc=eng,dc=br',
        ...
        'search.base' => 'ou=usuarios,dc=redes,dc=eng,dc=br',
    ...
    'privacyidea' => array(
        ...
        'privacyideaserver' => 'http://idpfido.cafeexpresso.rnp.br',
        'sslverifyhost' => False,
        'sslverifypeer' => False,
        'realm' => '',
        'attributemap' => array(
